...
{   
    ...
    ros::Subscriber pos_a= n.subscribe("a_avoid", 1000, aCallback);
    ros::Subscriber pos_b= n.subscribe("b_avoid", 1000, bCallback);
    ros::Subscriber pos_c= n.subscribe("c_avoid", 1000, cCallback);
    ros::Subscriber pos_d= n.subscribe("d_avoid", 1000, dCallback);
    ...
    ros::Publisher line1_pub = n.advertise<visualization_msgs::Marker>( "visualization_line1_avoid",0 );
    ros::Publisher line2_pub = n.advertise<visualization_msgs::Marker>( "visualization_line2_avoid",0 );
    ros::Publisher line3_pub = n.advertise<visualization_msgs::Marker>( "visualization_line3_avoid",0 );
    ros::Publisher circle_pub = n.advertise<visualization_msgs::Marker>( "visualization_circle",0 );
    ros::Publisher line4_pub = n.advertise<visualization_msgs::Marker>( "visualization_line4_avoid",0 );
